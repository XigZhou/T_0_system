...
from overnight_bt.stock_pool_feature_store import StockPoolFeatureUpdateConfig, run_stock_daily_feature_computation


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compute stock daily features from SQLite raw tables")
...
def main() -> None:
    ...
    summary = run_stock_daily_feature_computation(config)
